...
<link href="<%=basePath%>js/alertbox/jquery.alerts.css" rel="stylesheet" type="text/css" media="screen" />
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/select2.css"></link>
...
<body >
	<center>
		...
		<!-- <div id="wrapper" > -->
		<%-- <div class="container" style="background:#fff; box-shadow:none; ">
			<table border="0" height="800" bgcolor="white" cellspacing="0" cellpadding="0" align="center">
				<tr>
					<td>
