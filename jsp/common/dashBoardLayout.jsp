        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <h2 class="title-widget">Adilabad Profile</h2>
						<hr class="style14"/>
						
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<h4 class="mtitle">Flagship programs</h4>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<ul class="list-group-horizontal">
								  <li class="list-group-item"><a href="#" data-toggle="tooltip" title="Lorem ipsum dolor sit amet!">Lorem ipsum dolor sit amet. </a></li>
								  <li class="list-group-item"><a href="#" data-toggle="tooltip" title="Lorem ipsum dolor sit amet!">Lorem ipsum dolor sit amet. </a></li>
								  <li class="list-group-item"><a href="#" data-toggle="tooltip" title="Lorem ipsum dolor sit amet!">Lorem ipsum dolor sit amet. </a></li>
								  <li class="list-group-item"><a href="#" data-toggle="tooltip" title="Lorem ipsum dolor sit amet!">Lorem ipsum dolor sit amet. </a></li>
								  <li class="list-group-item"><a href="#" data-toggle="tooltip" title="Lorem ipsum dolor sit amet!">Lorem ipsum dolor sit amet. </a></li>
							...
							<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<h4 class="mtitle">Favorite programs</h4>
							</div>
						</div>
					...
					<%-- <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 right-block">
						<tiles:insert attribute="rightPanel" name="rightPanel" />
                    </div> --%>
                </div>
